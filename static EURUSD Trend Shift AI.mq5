//+------------------------------------------------------------------+
//| static EURUSD Trend Shift AI - Self Learning EA (MT5) - STATIC VERSION |
//+------------------------------------------------------------------+
#property copyright "Static Parameters Version"
#property description "EURUSD Trend Shift AI with hardcoded parameters"
...
//================ STATIC SETTINGS =================
// These values are now hardcoded and cannot be changed from inputs
static const double BaseLot   = 0.03;
static const double MaxLot    = 0.05;

static const int MA_Fast = 50;
static const int MA_Slow = 200;
static const int RSI_Period = 14;
static const int ATR_Period = 14;
static const double ATR_Mult = 2.0;
static const double TP_Mult = 1.5;

static const double BE_Pips = 20;
static const double Trail_Pips = 30;
static const double Trail_Step = 5;

// Minimum score for entry (1 to 100)
...
int OnInit()
{
   ...
   if(EnableLogging) 
   {
      Print("=== EURUSD Trend Shift AI - Static Version ===");
      Print("Lot: Base=", BaseLot, ", Max=", MaxLot);
      Print("MA: Fast=", MA_Fast, ", Slow=", MA_Slow);
      Print("RSI Period: ", RSI_Period);
      Print("ATR: Period=", ATR_Period, ", Multiplier=", ATR_Mult);
      Print("TP Multiplier: ", TP_Mult);
      Print("Break Even: ", BE_Pips, " pips");
      Print("Trailing: Start=", Trail_Pips, "pips, Step=", Trail_Step, "pips");
      Print("Minimum Entry Score: ", Min_Score);
      Print("=============================================");
   }
